  ...
  return (
    <div className="flex flex-col mx-auto text-center min-h-screen bg-hero bg-cover bg-no-repeat bg-center py-8 sm:py-10 px-8 sm:px-20">
      ...
      <div className="flex flex-col justify-center items-center mt-20">
        <h1 className="text-white text-3xl mb-5 font-semibold">Welcome Back</h1>
        <p className="text-white text-lg mb-14 font-normal">Sign into your Biamo account to continue</p>
        <form>
          ...
          <div className='flex justify-end mt-4 mb-10'>
            <h2 className='text-[#E14594] text-sm font-light'>Forgot Password</h2>
          </div>
          ...
          <p className="text-white text-center text-sm my-6">New to BIamo? <a href='/' className="text-[#e14594] font-semibold">Sign Up</a></p>
        </form>
      </div>
    </div>
  )
