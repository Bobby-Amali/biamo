...
const Tech = () => {
  return (
    <section className="flex flex-col lg:flex-row">
      <div className="flex flex-col justify-start lg:justify-center pt-14 lg:pt-0 pl-10 lg:pl-24 pr-10 lg:pr-0 gap-8 w-[full] lg:w-[50%] lg:h-[100vh] relative lg:sticky top-0" id="about">
      ...
      <div class="scroll py-24 lg:py-0">
        <div className='lg:h-[50vh] lg:pt-[100px] gap-6 pl-10 lg:pl-40 pr-10 lg:pr-24 pb-10 lg:pb-0'>
          <div className="w-12 h-12 bg-[#E14594] rounded-full text-center text-white">
            1
          </div>
          <h2 className='text-primary md:text-3xl font-semibold'>Revolutionary Service</h2>
        ...
        <div className='lg:h-[45vh] lg:pt-[30px] gap-6 pl-10 lg:pl-40 pr-10 lg:pr-24 pb-10 lg:pb-0'>
          <div className="w-12 h-12 bg-secondary rounded-full text-center text-white">
            2
          </div>
          <h2 className='text-primary md:text-3xl font-semibold'>Techie at Heart, Friendly in Spirit</h2>
          <p className='text-[#0d0d0c] opacity-80 text-base'>
        ...
        <div className='lg:h-[45vh] lg:pt-[30px] gap-6 pl-10 lg:pl-40 pr-10 lg:pr-24 pb-10 lg:pb-0'>
          ...
          <h2 className='text-primary md:text-3xl font-semibold'>Your Growth is Our Success</h2>
          <p className='text-[#0d0d0c] opacity-80 text-base'>
        ...
        <div className='lg:h-[45vh] lg:pt-[10px] gap-6 pl-10 lg:pl-40 pr-10 lg:pr-24 pb-10 lg:pb-0'>
          <div className="w-12 h-12 bg-primary rounded-full text-center text-white">
            4
          </div>
          <h2 className='text-primary md:text-3xl font-semibold'>Secure and Reliable</h2>
          <p className='text-[#0d0d0c] opacity-80 text-base'>
